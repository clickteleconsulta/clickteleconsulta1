        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              <Button variant="outline" size="sm" asChild className="gap-2 h-9 border-slate-200 hover:bg-brand-50 hover:border-brand-200 text-slate-600 hover:text-brand-600 text-xs">
                <a href={`mailto:${BRAND.emails.suporte}`}><Mail className="w-3.5 h-3.5" /> Email</a>
              </Button>
            </div>
          </div>
        </div>
