  ...
  return (
    <div className="w-full md:w-[320px] bg-white border-r border-gray-200 flex flex-col h-full overflow-y-auto shrink-0 transition-all duration-300">
      ...
      <div className="px-6 flex flex-col items-center text-center">
        <Avatar className="h-24 w-24 mb-4 border-4 border-brand-50">
          <AvatarImage src={patient.avatar_url} />
          <AvatarFallback className="bg-brand-200 text-brand-800 text-xl font-medium">
            {initials}
          </AvatarFallback>
        </Avatar>
        ...
        <div className="flex items-center justify-center gap-2 mt-6 w-full">
          <Button aria-label="Enviar mensagem ao paciente" variant="outline" size="icon" className="rounded-md h-10 w-10 border-gray-200 text-gray-500 hover:text-brand-600 hover:border-brand-200 hover:bg-brand-50">
            <MessageSquare className="h-4 w-4" />
          </Button>
          <Button aria-label="Ver agenda do paciente" variant="outline" size="icon" className="rounded-md h-10 w-10 border-gray-200 text-gray-500 hover:text-brand-600 hover:border-brand-200 hover:bg-brand-50">
            <Calendar className="h-4 w-4" />
          </Button>
          <Button aria-label="Ver pagamentos do paciente" variant="outline" size="icon" className="rounded-md h-10 w-10 border-gray-200 text-gray-500 hover:text-brand-600 hover:border-brand-200 hover:bg-brand-50">
            <Wallet className="h-4 w-4" />
          </Button>
          <Button aria-label="Ver dados do paciente" variant="outline" size="icon" className="rounded-md h-10 w-10 border-gray-200 text-gray-500 hover:text-brand-600 hover:border-brand-200 hover:bg-brand-50">
            <User className="h-4 w-4" />
          </Button>
          <Button aria-label="Mais ações do paciente" variant="outline" size="icon" className="rounded-md h-10 w-10 border-gray-200 text-gray-500 hover:text-gray-900">
      ...
      <div className="px-6">
        <button 
          ...
          className="flex items-center gap-3 w-full text-sm font-medium text-gray-600 hover:text-brand-600 transition-colors p-2 rounded-lg hover:bg-brand-50 -ml-2"
        >
