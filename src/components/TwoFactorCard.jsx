...
import { Loader2, ShieldCheck, Smartphone, Copy } from '@/components/ui/icones';
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="flex-1 space-y-2 w-full">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button aria-label="Copiar a chave de verificação" type="button" variant="outline" size="icon" onClick={copySecret} className="shrink-0"><Copy className="w-4 h-4" /></Button>
                </div>
              </div>
            </div>
