...
import { Loader2, AlertTriangle, CheckCircle2 } from '@/components/ui/icones';
        ...
        behavior: 'smooth'
            ...
            <section className="bg-gray-50 rounded-lg p-6 sm:p-8 border border-gray-100 space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                ...
                <div className="flex justify-end pt-4 border-t border-gray-200 mt-6">
                    <Button size="lg" onClick={handleInitiateChange} disabled={!hasChanges || saving} className={selectedPlanDetails.id === 'professional' || selectedPlanDetails.id === 'premium' ? "bg-brand-600 hover:bg-brand-700 shadow-md" : ""}>
