...
const DoctorReviewsPage = () => {
    ...
    const ReviewCard = ({ review, isReported = false }) => {
        ...
        return (
            <Card className="mb-4 overflow-hidden border-gray-200 rounded-lg shadow-sm transition-all duration-300 hover:shadow-md">
                    ...
                    {!isReported && (
                        <div className="mt-4 flex justify-end">
                            <Button 
                                variant="outline" 
                                size="sm" 
                                className="text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200 rounded-md transition-all duration-200"
