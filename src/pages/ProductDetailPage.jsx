...
import { ShoppingCart, Loader2, ArrowLeft, CheckCircle2, Minus, Plus, XCircle, ChevronLeft, ChevronRight } from '@/components/ui/icones';
            ...
            <div className="mt-auto">
              ...
              {isStockManaged && canAddToCart && product.purchasable && (
                <p className="text-sm text-green-400 mt-3 flex items-center justify-center gap-2">
                  <CheckCircle2 size={16} /> {availableStock} in stock!
                </p>
              )}
